...
App.module("Grid", function(Grid, App, Backbone, Marionette, $, _) {
  ...
  Grid.visibleThumbnailsCollection = App.projectsCollection.getVisibleThumbnailModels();

  // create an instance of GridCollectionView
  Grid.collectionView = new App.GridCollectionView({
    collection: Grid.visibleThumbnailsCollection
  });

  // initial render grid
  App.mainRegion.show(Grid.collectionView);
